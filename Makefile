...
# Generated by qmake (2.01a) (Qt 4.8.1) on: Tue Dec 25 10:46:05 2012
...
excutableAlg.o: excutableAlg.cpp excutableAlg.h \
		detectAlg.h \
		globalInclude.h \
		model.h \
		featureIO.h \
		cluster.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o excutableAlg.o excutableAlg.cpp
